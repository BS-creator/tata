  ...
  var r = function (n) {
    ...
    TableTools.prototype = {
      ...
      _fnButtonDefinations   : function (a, b) {
        ...
        if (this.s.master) {
          ...
          f(b.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function (c) {
            var d = this.nodeName.toLowerCase() === "tr" ? this : f(this).parents("tr")[0], e = a.s.select, j = a.s.dt.oInstance.fnGetPosition(d);
        ...
        if (a.nodeName)c =
          ...
          d = 0;
          for (e = a.length; d < e; d++)a[d].nodeName ? (c = this.s.dt.oInstance.fnGetPosition(a[d]), b
        .
          push(this.s.dt.aoData[c])
        ):
      ...
      _fnFlashConfig         : function (a, b) {
        ...
        var b, c, d, e, j, i = [], h = "", g = this.s.dt, k, l = RegExp(a.sFieldBoundary, "g"), m = this._fnColumnTargets(a.mColumns), n = "undefined" != typeof a.bSelectedOnly ? a.bSelectedOnly : !1;
        if (a.bHeader) {
          j = [];
          b = 0;
        ...
        var p = this.fnGetSelected(), n = "none" !== this.s.select.type && n && 0 !== p.length, q = (d = f.fn.dataTable.Api) ? (new d(g)).rows(a.oSelectorOpts).indexes().flatten().toArray() : g.oInstance.$("tr", a.oSelectorOpts).map(function (a, b) {
