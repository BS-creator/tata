    ...
    $.jstree.core.prototype = {
        ...
        init: function (el, options) {
            ...
            this._data.core.original_container_html
                ...
                .remove();
            this.element.html("<" + "ul class='jstree-container-ul jstree-children'><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last'><" + "a class='jstree-anchor' href='#'>" + this.get_string("Loading ...") + "</a></li></ul>");
        ...
        refresh: function (skip_loading, forget_state) {
            ...
            if (!skip_loading) {
                this.element.html("<" + "ul class='" + c + "'><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last'><" + "a class='jstree-anchor' href='#'>" + this.get_string("Loading ...") + "</a></li></ul>");
            }
...
// TODO: move logic outside of function + check multiple move
    ...
    $.jstree.plugins.contextmenu = function (options, parent) {
        this.bind = function () {
             ...
             */
            $(document).on("context_hide.vakata", $.proxy(function () {
            ...
            this.element
                .on('mousedown.jstree touchstart.jstree', '.jstree-anchor', $.proxy(function (e) {
                    ...
                    if (obj && obj.id && obj.id !== "#" && (e.which === 1 || e.type === "touchstart") &&
                        ...
                        return $.vakata.dnd.start(e, { 'jstree': true, 'origin': this, 'obj': this.get_node(obj, true), 'nodes': mlt > 1 ? this.get_selected() : [obj.id] }, '<div id="jstree-dnd" class="jstree-' + this.get_theme() + ( this.settings.core.themes.responsive ? ' jstree-dnd-responsive' : '' ) + '">' + (mlt > 1 ? mlt + ' ' + this.get_string('nodes') : this.get_text(e.currentTarget, true)) + '<ins class="jstree-copy" style="display:none;">+</ins></div>');
                    }
                }, this));
        };
    };
